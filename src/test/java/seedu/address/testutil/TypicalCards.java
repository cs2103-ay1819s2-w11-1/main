...
public class TypicalCards {
    public static final Card ADDITION = new CardBuilder().withQuestion("Solve 1 + 1.").withAnswer("2").withTags("Math")
                                                         .build();

    public static final Card SUBTRACTION = new CardBuilder().withQuestion("What is 10 - 10?").withAnswer("0")
                                                            .withTags("Math").build();

    public static final Card MULTIPLICATION = new CardBuilder().withQuestion("What is 8 * 8?").withAnswer("64")
                                                               .withTags("Math").build();
    ...
    public static final Card HELLO_WORLD = new CardBuilder().withQuestion("Hello?").withAnswer("World")
                                                            .withTags("Simple", "CS").build();

    public static final Card NO_TAG = new CardBuilder().withQuestion("Are there any tag?").withAnswer("No").build();

    public static final Card UNIQUE = new CardBuilder().withQuestion("Is this card unique?").withAnswer("Yes it is.")
                                                       .build();

    public static final Card LAYER = new CardBuilder().withQuestion("Which layer is HTTP at?").withAnswer("Application")
