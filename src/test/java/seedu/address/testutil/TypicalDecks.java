...
public class TypicalDecks {
    ...
    public static final Deck DECK_D = new DeckBuilder().withName("Darwinian Studies").withCards(getTypicalCards())
                                                       .build();
    ...
    public static final Deck THERE = new DeckBuilder().withName("Baby there").withCards(getTypicalCards()).build();
    ...
    public static List<Deck> getTypicalDecks() {
        return new ArrayList<>(
                Arrays.asList(DECK_WITH_CARDS, DECK_A, DECK_B, DECK_C, DECK_D, DECK_E, THERE, NOTHING, HOLDING));
    }
}
