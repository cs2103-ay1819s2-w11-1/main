...
public class TestApp extends MainApp {
    ...
    public TestApp(Supplier<ReadOnlyTopDeck> initialDataSupplier, Path saveFileLocation) {
        ...
        if (initialDataSupplier.get() != null) {
            JsonTopDeckStorage jsonTopDeckStorage = new JsonTopDeckStorage(saveFileLocation);
            try {
                jsonTopDeckStorage.saveTopDeck(initialDataSupplier.get());
    ...
    protected UserPrefs initPrefs(UserPrefsStorage storage) {
        ...
        userPrefs.setTopDeckFilePath(saveFileLocation);
        return userPrefs;
    }
     ...
     */
    public TopDeck readStorageTopDeck() {
        try {
