...
public class AddDeckCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        // clean
        assertParseSuccess(parser, VALID_DECK_NAME_A_ARGS, new AddDeckCommand(expectedDeck));

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + VALID_DECK_NAME_A_ARGS, new AddDeckCommand(expectedDeck));
    }
