...
public class JsonSerializableTopDeckTest {
    ...
    public void toModelType_typicalDecksFile_success() throws Exception {
        JsonSerializableTopDeck dataFromFile = JsonUtil.readJsonFile(TYPICAL_DECKS_FILE, JsonSerializableTopDeck.class)
                                                       .get();
    ...
    public void toModelType_invalidDeckFile_throwsIllegalValueException() throws Exception {
        JsonSerializableTopDeck dataFromFile = JsonUtil.readJsonFile(INVALID_DECK_FILE, JsonSerializableTopDeck.class)
                                                       .get();
    ...
    public void toModelType_duplicateDecksFile_throwsIllegalValueException() throws Exception {
        JsonSerializableTopDeck dataFromFile = JsonUtil.readJsonFile(DUPLICATE_DECK_FILE, JsonSerializableTopDeck.class)
                                                       .get();
        thrown.expect(IllegalValueException.class);
    ...
    public void toModelType_duplicateCardsFile_throwsIllegalValueException() throws Exception {
        JsonSerializableTopDeck dataFromFile = JsonUtil.readJsonFile(DUPLICATE_CARD_FILE, JsonSerializableTopDeck.class)
                                                       .get();
